Физико Механический институт\documentclass{article}
...
Выполнила студент \\группы 5030102/90101 && Кузин Иван Никитович \\
\\
...
\subsection{Эмпирическая функция распределения}
	\begin{figure}[H]
	\centering
	{\includegraphics[scale=0.51]{Normal100.jpg}}
		\caption{нормальное распределение}
		\label{fig:normal}
	\end{figure}

\begin{figure}[H]
	{\includegraphics[scale=0.51]{Cauchy100.jpg}}
		\caption{распределение Коши}
		\label{fig:normal}
	\end{figure}

\begin{figure}[H]
	{\includegraphics[scale=0.51]{Laplace100.jpg}}
		\caption{распределение Лапласа}
		\label{fig:normal}
	\end{figure}

\begin{figure}[H]
	{\includegraphics[scale=0.51]{Poisson100.jpg}}
		\caption{распределение Пуассона}
		\label{fig:normal}
	\end{figure}

\begin{figure}[H]
	{\includegraphics[scale=0.51]{Uniform100.jpg}}
...
\begin{figure}[H]
	{\includegraphics[scale=0.51]{NormalKDE20.jpg}}
		\caption{нормальное распределение, $n=20$}
		\label{fig:normal}
	\end{figure}

\begin{figure}[H]
	{\includegraphics[scale=0.51]{NormalKDE60.jpg}}
		\caption{нормальное распределение, $n=60$}
		\label{fig:normal}
	\end{figure}

\begin{figure}[H]
	{\includegraphics[scale=0.51]{NormalKDE100.jpg}}
		\caption{нормальное распределение, $n=100$}
		\label{fig:normal}
	\end{figure}

\begin{figure}[H]
	{\includegraphics[scale=0.51]{CauchyKDE20}}
		\caption{распределение Коши, $n=20$}
		\label{fig:normal}
	\end{figure}

\begin{figure}[H]
	{\includegraphics[scale=0.51]{CauchyKDE60.jpg}}
		\caption{распределение Коши, $n=60$}
		\label{fig:normal}
	\end{figure}

\begin{figure}[H]
	{\includegraphics[scale=0.51]{CauchyKDE100.jpg}}
		\caption{распределение Коши, $n=100$}
		\label{fig:normal}
	\end{figure}

\begin{figure}[H]
	{\includegraphics[scale=0.51]{LaplaceKDE20.jpg}}
		\caption{распределение Лапласа, $n=20$}
		\label{fig:normal}
	\end{figure}

\begin{figure}[H]
	{\includegraphics[scale=0.51]{LaplaceKDE60.jpg}}
		\caption{распределение Лапласа, $n=60$}
		\label{fig:normal}
	\end{figure}

\begin{figure}[H]
	{\includegraphics[scale=0.51]{LaplaceKDE100.jpg}}
		\caption{распределение Лапласа, $n=100$}
		\label{fig:normal}
	\end{figure}

\begin{figure}[H]
	{\includegraphics[scale=0.51]{PoissonKDE20.jpg}}
		\caption{распределение Пуассона, $n=20$}
		\label{fig:normal}
	\end{figure}

\begin{figure}[H]
	{\includegraphics[scale=0.51]{PoissonKDE60.jpg}}
		\caption{распределение Пуассона, $n=60$}
		\label{fig:normal}
	\end{figure}

\begin{figure}[H]
	{\includegraphics[scale=0.51]{PoissonKDE100.jpg}}
		\caption{распределение Пуассона, $n=100$}
		\label{fig:normal}
	\end{figure}

\begin{figure}[H]
	{\includegraphics[scale=0.51]{UniformKDE20.jpg}}
		\caption{равномерное распределение, $n=20$}
		\label{fig:normal}
	\end{figure}

\begin{figure}[H]
	{\includegraphics[scale=0.51]{UniformKDE60.jpg}}
		\caption{равномерное распределение, $n=60$}
		\label{fig:normal}
	\end{figure}

\begin{figure}[H]
	{\includegraphics[scale=0.51]{UniformKDE100.jpg}}
