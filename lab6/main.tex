...
\subsection{Оценки коэффициентов линейной регрессии}
	...
	\subsubsection{Выборка без возмущений}
		\begin{enumerate}
			...
			$\hat{a}\approx 1.81$, $\hat{b}\approx 1.72$
			\item{Критерий наименьших модулей:}
			$\hat{a}\approx 1.87$, $\hat{b}\approx 1.93$
		\end{enumerate}
		\begin{figure}[H]
			\centering
			\includegraphics[width = 10cm, height = 8cm]{NoPerturbations.jpg}
	...
	\subsubsection{Выборка с возмущениями}
		\begin{enumerate}
			\item{Критерий наименьших квадратов:}
			$\hat{a}\approx 2.20$, $\hat{b}\approx 0.39$
			\item{Критерий наименьших модулей:}
			$\hat{a}\approx 2.48$, $\hat{b}\approx 2.08$
		\end{enumerate}
		\begin{figure}[H]
			\centering
			\includegraphics[width = 10cm, height = 8cm]{Perturbations.jpg}
