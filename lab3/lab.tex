...
\subsection{Боксплот Тьюки}
\begin{figure}[H]
\center{\includegraphics[scale=0.75]{NormalNumber}}
\label{fig:image}
\caption{Нормальное распределение}
\end{figure}

\begin{figure}[H]
\center{\includegraphics[scale=0.75]{CauchyNumber}}
\label{fig:image}
\caption{распределение Коши}
\end{figure}

\begin{figure}[H]
\center{\includegraphics[scale=0.75]{LaplaceNumber}}
\label{fig:image}
\caption{распределение Лапласа}
\end{figure}

\begin{figure}[H]
\center{\includegraphics[scale=0.75]{PoissonNumber}}
\label{fig:image}
\caption{распределение Пуассона}
\end{figure}

\begin{figure}[H]
\center{\includegraphics[scale=0.75]{UniformNumber}}
\label{fig:image}
...
\newline https://github.com/workivan/mat-ver-stat.git
